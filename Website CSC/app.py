...
def public_about_html():
    return render_template('public/about.html')

@app.route('/contact.html')
def public_contact_html():
    return render_template('public/contact.html')

@app.route('/login.html')
def public_login_html():
    return redirect(url_for('login'))

@app.route('/service1.html')
def public_service1():
    return render_template('public/service1.html')

@app.route('/service2.html')
def public_service2():
    return render_template('public/service2.html')

@app.route('/service3.html')
def public_service3():
    return render_template('public/service3.html')

@app.route('/service4.html')
def public_service4():
    return render_template('public/service4.html')
